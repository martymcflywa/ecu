 ...
 * Blast.java
 *
 * Created on 17 March 2008, 16:48
 *
 */
 ...
 * @author phingsto
 */
public class Blast extends Mover implements Constants
{
    ...
    public Blast(Starfield field, double x, double y, double heading, double power, int ownerID)
    {
        super(field, BLAST_SPEED, BLAST_SPEED, RADIUS);
    ...
    public void update(double seconds)
    {
        ...
        power -= BLAST_SPEED*BLAST_DECAY*seconds;
    }
    ...
    {
        int level = 127+(int)(128*power/SAUCER_MAX_POWER);
