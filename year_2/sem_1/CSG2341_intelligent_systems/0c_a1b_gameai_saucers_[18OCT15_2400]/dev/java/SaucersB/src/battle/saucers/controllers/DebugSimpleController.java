 ...
 * 
 */
public class DebugSimpleController implements SaucerController, Constants
{
    private static final String NAME = "debug simple";
    ...
    public void senseSaucers(ArrayList<SensorData> data) 
    {
        ...
        System.out.println("target direction: " + target.direction);
        System.out.println("target heading: " + target.heading);
        System.out.println("target speed: " + target.speed);
    }
