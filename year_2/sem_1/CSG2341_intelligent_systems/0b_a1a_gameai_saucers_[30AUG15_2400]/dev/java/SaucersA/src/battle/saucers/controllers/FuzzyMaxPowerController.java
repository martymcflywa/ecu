 ...
 * @author phingsto
 */
public class FuzzyMaxPowerController implements SaucerController
{
    ...
    private static final String NAME = "fuzzyMaxPower";
    ...
    public FuzzyMaxPowerController() throws FuzzyException
    {
