...
\fancypagestyle{fancylscape}{
	...
	\end{textblock}
		...
		{\rotatebox{90}{Assignment 2: Implementation and operation of ext3 filesystem}}
	\end{textblock}
...
\\\leavevmode\\CSG1102\\Operating Systems
\\\leavevmode\\Assignment 2
\\\leavevmode\\Implementation and operation
...
\newpage
\input{./sections/10_executive_summary}
\input{./sections/20_intro_to_journaling}
\input{./sections/30_ext3_discussion}
\newpage
...
\bibliography{./bib/Year_2-Sem_1-CSG1102-0c_A2}
