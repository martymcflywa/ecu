...
% front matter
\title{Edith Cowan University\\CSG1132\\Communicating in an IT Environment\\Assignment 1b}
\author{Literature review:\\Factors and attitudes that shape personal use of social media\\\\
...
\include{./sections/plan/litreview_plan}

\urlstyle{rm}
%\setbibref{\textsf{References}}
\bibliographystyle{apacite}
%\addcontentsline{toc}{section}{References}
\bibliography{./bib/CSG1132-Assignment_1B-Cite}
