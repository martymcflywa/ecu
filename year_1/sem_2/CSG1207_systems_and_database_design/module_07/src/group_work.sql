--  **************************************************************************************
--  Creation and Population Script for the 'group_work' database.
--  This database is used in Module 7 of CSG1207/CSI5135.
--  **************************************************************************************
...
(  assn_id INT NOT NULL IDENTITY CONSTRAINT assn_pk PRIMARY KEY,
   ...
   assn_type TINYINT NOT NULL CONSTRAINT assn_assn_type_fk FOREIGN KEY REFERENCES assignment_type(assn_type_id),
