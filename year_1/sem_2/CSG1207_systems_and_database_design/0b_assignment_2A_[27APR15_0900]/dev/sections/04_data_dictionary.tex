...
\begin{table}[H]
  ...
  \caption{\textbf{``customer''} stores details about customer}
    ...
    cust\_email & VARCHAR(20) & NOT NULL & CHECK (cust\_email LIKE `\_\%@\_\%.\_\_\_\%') &  \\
    \end{tabular}%
    \end{scriptsize}
\end{table}%
...
\begin{table}[H]
  ...
  \caption{\textbf{``pizza\_crust''} stores details about pizza crust}
    ...
    surcharge & DECIMAL(3,2) & NOT NULL &       & DEFAULT 0.00 \\
    \end{tabular}%
    \end{scriptsize}
\end{table}%
...
\begin{table}[H]
  ...
  \caption{\textbf{``pizza\_range''} stores details about pizza range}
    ...
    pizza\_range\_name & VARCHAR(20) & NOT NULL & UNIQUE &  \\
