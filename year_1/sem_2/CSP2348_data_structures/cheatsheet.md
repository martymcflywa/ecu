...
To calculate a balanced tree depth d when given a number of nodes n:

>d = floor(log<sub>2</sub>n)

To calculate a balanced tree's nodes n when given depth d:

>2<sup>d+1</sup> - 2

#### Calculating depth d example

What is the maximum depth of a balanced binary tree of 30 nodes?

d = floor(log<sub>2</sub>30)  
log<sub>2</sub>16 = 4, log<sub>2</sub>32 = 5  
floor(log<sub>2</sub>30) = 4

#### Calculating node n example

How many nodes does a balanced binary tree of depth d = 2 have?
...
To calculate a fully balanced tree depth d when given a number of nodes n:

>d = floor(log<sub>2</sub>n)

To calculate a fully balanced tree's nodes n when given depth d:

>2<sup>d+1</sup> - 1

#### Calculating depth d example

What is the maximum depth of a fully balanced tree of 128 nodes?

d = floor(log<sub>2</sub>128)  
= 7

#### Calculating node n example

How many nodes does a fully-balanced binary tree of depth d = 4 have?
...
>1. If top is not null:
	1. Visit top
	2. Travers, in pre-order, top's left subtree
...
##### BST insertion ascending/descending order
